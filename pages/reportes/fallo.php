            ...
            <div class="content-header row">
                <div class="content-header-left col-md-9 col-12 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h2 class="content-header-title float-start mb-0">Sentido de Fallo</h2>
                            <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active">Sentido de Fallo
                                    </li>
                                </ol>
                            </div>
                        </div>
                            ...
                            <table class="user-list-table table">
                                <thead class="table-light">
                                    <tr>
                                        ...
                                        <th style="width: 50px">PUBLICACION</th>
                                        <th style="width: 30%">JUZGADO</th>
                                        <th style="width: 10%">FECHA FALLO</th>
