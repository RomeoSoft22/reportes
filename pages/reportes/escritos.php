            ...
            <div class="content-header row">
                <div class="content-header-left col-md-9 col-12 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h2 class="content-header-title float-start mb-0">Escritos Pendientes</h2>
                            <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active">Escritos Pendientes
                                    </li>
                                </ol>
                            </div>
                        </div>
                    ...
                    <div class="card-body">
                        <form id="val-formulario">
                            <div class="row">
                                ...
                                <div class="col-md-4 col-12">
                                    <label class="form-label" for="c_especialidad">Especialidad</label>
                                    <div class="mb-1">
                                        <select class="select2 form-select" id="c_especialidad">
                                        <option value='0'>Seleccionar Especialidad</option>
                                        <option value='CI'>CIVIL</option> 
                                        <option value='PE'>PENAL</option>
                                        <option value='LA'>LABORAL</option>
                                        <option value='FC'>FAMILIA CIVIL</option>
                                        <option value='FP'>FAMILIA PENAL</option>
                            ...
                            <table class="user-list-table table">
                                <thead class="table-light">
                                    <tr>
                                        ...
                                        <th style="width: 30%">SECRETARIO</th>
                                        <th style="width: 20%">EXPEDIENTE</th>
                                        <th style="width: 20px">ESCRITO</th>
                                        <th style="width: 30px">FECHA INGRESO</th>
