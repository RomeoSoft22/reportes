        ...
        <div class="content-wrapper">
            ...
            <div class="content-body">
                ...
                <div class="misc-wrapper"><a class="brand-logo" href="<?=$url?>">
                        <h2 class="brand-text text-primary ms-1">Sistema de Reportes</h2>
                    </a>
                    <div class="misc-inner p-2 p-sm-3">
                        <div class="w-100 text-center">
                        <p class="mb-1"></p>
                            <h2 class="mb-1">Pagina no Encontrada!!! 🕵🏻‍♀️</h2>
                            <p class="mb-2">Oops! 😖 La URL solicitada no se encontró en este servidor.</p>
                            <a class="btn btn-primary mb-2 btn-sm-block" href="<?=$url?>">Ir al inicio</a>
