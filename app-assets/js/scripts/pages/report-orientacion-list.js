...
$(function () {
    ...
    var url_api = getCookie('api'),
        consultaSQL = "ConsultaOrientacion",
        ...
        responsive: {
          details: {
            display: $.fn.dataTable.Responsive.display.modal({
              header: function (row) {
                var data = row.data();
                return 'Detalle de  ' + data['atencion'];
              }
            }),
            type: 'column',
