...
$(function () {
  ...
  var setParameters = function(){
    ...
    $("#buscarRP").click(function(){
        id = 1;
        setParameters();
        tabla.ajax.url(url_api+'ConsultaFirmas').load();
    });
      ...
      responsive: {
        details: {
          display: $.fn.dataTable.Responsive.display.modal({
            header: function (row) {
              var data = row.data();
              return 'Detalle del ' + data['usuario'];
            }
          }),
          type: 'column',
  ...
  $("#c_provincia").change(function () {
        $("#c_provincia option:selected").each(function () {
            ...
            $.post(url_api+"ConsultaSede", {c_provincia: c_provincia}, function (data) {
