...
$(function () {
    ...
    if (dtUserTable.length) {
      var tabla = dtUserTable.DataTable({
        ...
        columns: [
          ...
          { data: 'Juzgado' },
          { data: 'FechaSentidoFallo' },
          { data: 'Expediente' },
          { data: 'EstadoPublicacion' },
          { data: 'UsuarioPublico' },
          { data: 'CargoUsuarioPublico' }
        ],
        columnDefs: [
          {
            // item
          ...
          },
          {
            targets: 1,
            render: function (data, type, full, meta) {
              var $datos = full['FechaPublicacion'];
              return $datos;
            }
          },
          {
          ...
          },
          {
            targets: 3,
            render: function (data, type, full, meta) {
              var $datos = full['FechaSentidoFallo'];
              return $datos;
            }
          },
          {
          ...
          },
          {
            targets: 5,
            render: function (data, type, full, meta) {
              var $datos = full['EstadoPublicacion'];
              return $datos;
            }
          },
          {
          ...
          },
          {
            targets: 7,
            render: function (data, type, full, meta) {
              var $datos = full['CargoUsuarioPublico'];
              return $datos;
            }
          }
        ],
    ...
    $("#c_sede").change(function () {
          $("#c_sede option:selected").each(function () {
              ...
              $.post(url_api+"ConsultaDependencia", {c_sede: c_sede, eje:'N'}, function (data) {
                  for(i=0;i<Object.keys(data).length;i++){
