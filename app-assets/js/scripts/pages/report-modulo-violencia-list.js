      ...
      $("#buscarRP").click(function(){
          ...
          if((fecha!="") && (c_distrito!="")){
            ...
            tabla.ajax.url(url_api+consultaSQL).load();
              ...
              if (c_distrito=="") $("#c_distrito").addClass('error');
          }         
      });
